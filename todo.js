$(document).ready(function(){
    ...
    function addTodo(todoText) {
        if (todoText) {
            $('#todo-list').append('<li class ="d-flex align-items-center list-group-item" ><span class="flex-item-1">'+ todoText +'</span><button type="button" class=" btn btn-small btn-success"><i class="fa fa-check"></i></button></li>')
    ...
    $('#todo-list').on('click', 'button', function(){
        ...
        $(this).parent.append('#completed-list');
    })
